...
class CreateListModalBottomSheet extends StatefulWidget {
   const CreateListModalBottomSheet({Key? key, required this.boardId}) : super(key: key);
   final int boardId;
  @override
...
class _CreateListModalBottomSheetState extends State<CreateListModalBottomSheet> {
  ...
  _onClickCreateList(BuildContext context){
      BlocProvider.of<ListsOfBoardCubit>(context).createList(
          widget.boardId, _titleController.text);
